...
**Our results of 92.4%, 85.7%, and 84.5% accuracy on our training, validation, and test sets are slightly lower than the published results of Wagstaff et al.** This was to be expected since our network is trained from scratch. Our model is still remarkably more accurate than the two baselines, and it is only about 1/3 the size of the Wagner et al. model, with 18 million parameters compared to AlexNet's 60 million. 
